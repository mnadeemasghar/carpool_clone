...
class NewCommentOnRideWhichUserInvolved extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->greeting('Hello!')
            ->line('We wanted to let you know that someone just commented on a ride you are interested in.')
